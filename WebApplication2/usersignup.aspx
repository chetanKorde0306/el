    ...
    <div class="container">
      <div class="row">
         <div class="col">
            ...
            <div class="card" style="margin:5rem auto;width:70%">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto " style="width:100%">
                        <center>
                           <div class="form-group">
                              <asp:Button class="btn btn-primary btn-block btn-lg" ID="Button1" runat="server" style="width:100%" Text="Sign up" OnClick="Button1_Click" />
                           </div>
                        </center>
                     </div>
                  </div>
